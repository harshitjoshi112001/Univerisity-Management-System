...
//        courselist.setSelectedIndex(-1);          //by using this it set the combo box set null
    ...
    public void actionPerformed(ActionEvent ae)
    {
        ...
        {
            if(sroll.getSelectedItem()=="Select Roll no")
            {
                flag=0;
                JOptionPane.showMessageDialog(null, "Please Search Roll number First");
            }
            else
            {
                try{
                    ...
                    while(rs.next())
                    {
                        ...
                        coursebranch.setText(rs.getString("Branch"));
                        courselist.setText(rs.getString("Course"));
                    }
                }catch(Exception e)
                {e.printStackTrace();}
            }
        ...
        if(flag==1 && ae.getSource() == submit)
        {
            ...
            else if(addressfield.getText().equals("") || emailfield.getText().equals("") || phone.getText().equals("") || courselist.getText().equals(""))
            {
                JOptionPane.showMessageDialog(null, "Please Fill Details !!!");
            }
            else if(courselist.getText().equals("Btech") || courselist.getText().equals("btech") ||courselist.getText().equals("b.tech") || courselist.getText().equals("B.tech"))
            {
                if(coursebranch.getText().equals(""))
                {
                    JOptionPane.showMessageDialog(null, "Please fill branch also..This is necessary for Btech and Mtech students");
                }
            }
            else
            {
                ...
                try{
                    Connectionclass conn=new Connectionclass();
                    int rs=conn.stm.executeUpdate("update student set Address='"+addr+"' , EMail='"+ema+"',Phone_No='"+pho+"',Course='"+coursename+"',Branch='"+courseb+"' where Roll_No = '"+roll+"'");
                    if(rs==1)
                    {
